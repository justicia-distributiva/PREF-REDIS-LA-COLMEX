...
figure9 <- ggplot(within, 
  ...
  labs(x = "Corruption", y =  "Support for redistribution",
       caption = str_wrap("Notas: LAPOP 2008-2023. Estadísticas descriptivas ponderadas. Medias de preferencias redistributivas y corrupción, por país y año.", width = 120)) + 
  scale_color_grey(start = 0.8, end = 0.2, name = "Año") +  
  scale_y_continuous("Preferencias redistributivas", limits = c(4, 6.5)) +
