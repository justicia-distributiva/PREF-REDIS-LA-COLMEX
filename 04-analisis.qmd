...
#| label: fig-educ-redis
 knitr::include_graphics(path = here::here("output/graphs/Figure4.jpg"))
```
...
#| label: fig-pol-redis
 knitr::include_graphics(path = here::here("output/graphs/Figure5.jpg"))
```
...
```{r multilevel3, echo=FALSE, fig.cap="Coeficientes de regresión multinivel sobre preferencias redistributivas", message=FALSE, warning=FALSE, results='asis', fig.height=6}
